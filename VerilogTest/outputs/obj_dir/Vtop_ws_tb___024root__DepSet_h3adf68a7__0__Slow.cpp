...
VL_ATTR_COLD void Vtop_ws_tb___024root___ctor_var_reset(Vtop_ws_tb___024root* vlSelf) {
    ...
    vlSelf->top_ws_tb__DOT__val = VL_RAND_RESET_I(8);
    ...
    vlSelf->top_ws_tb__DOT__dut__DOT__stream_cnt = VL_RAND_RESET_I(32);
    vlSelf->top_ws_tb__DOT__dut__DOT__stream_len = VL_RAND_RESET_I(32);
